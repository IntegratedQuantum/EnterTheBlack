...
public class ShipSelection extends Screen {
	...
	public void paint(Graphics2D g) {
		...
		g.drawImage(Assets.ships.get(ship1), 760, 150, 200, 200, null);
		...
		if (ship1 != 4 && ship1 != 5) {
			...
			for (int i = 0; i < 5; i++) {
				g.drawString("" + Assets.getWeaponStat(Assets.getShipStat(ship1, Assets.SECONDARY), i), 1800, (int)((200 + i * 25)));
			}
			g.drawString(Assets.weaponname[Assets.getShipStat(ship1, Assets.SECONDARY)], 1800, 175);
		} 
		for (int i = 1; i < 5; i++) {
		...
		g.drawString(Assets.weaponname[Assets.getShipStat(ship1, Assets.PRIMARY)], 1500, 175);
		g.drawImage(Assets.ships.get(ship2), 760, 650, 200, 200, null);
		...
		if (ship2 != 4 && ship2 != 5) {
			...
			for (int i = 0; i < 5; i++) {
				g.drawString("" + Assets.getWeaponStat(Assets.getShipStat(ship2, Assets.SECONDARY), i), 1800, (int)((700 + i * 25)));
			}
			g.drawString(Assets.weaponname[Assets.getShipStat(ship2, Assets.SECONDARY)], 1800, 675);
		} 
		for (int i = 0; i < 5; i++) {
		...
		g.drawString(Assets.weaponname[Assets.getShipStat(ship2, Assets.PRIMARY)], 1500, 675);
	}
